...
wire                          [256-1:0] axi4_s0_wdata               ; 
wire                           [32-1:0] axi4_s0_wstrb               ; 
wire                                    axi4_s0_wlast               ; 
wire                                    axi4_s0_wvalid              ; 
wire                                    axi4_s0_wready              ; 
...
wire                  [NUM_SLAVE*4-1:0] m_axi4_arid                 ; 
wire                 [NUM_SLAVE*32-1:0] m_axi4_araddr               ; 
wire                  [NUM_SLAVE*8-1:0] m_axi4_arlen                ; 
wire                  [NUM_SLAVE*3-1:0] m_axi4_arsize               ; 
wire                  [NUM_SLAVE*2-1:0] m_axi4_arburst              ; 
wire                  [NUM_SLAVE*4-1:0] m_axi4_arion                ; 
wire                    [NUM_SLAVE-1:0] m_axi4_arlock               ; 
wire                  [NUM_SLAVE*4-1:0] m_axi4_arcache              ; 
wire                  [NUM_SLAVE*3-1:0] m_axi4_arprot               ; 
wire                  [NUM_SLAVE*4-1:0] m_axi4_arqos                ; 
wire                  [NUM_SLAVE*2-1:0] m_axi4_aruser               ; 
wire                    [NUM_SLAVE-1:0] m_axi4_arvalid              ; 
wire                    [NUM_SLAVE-1:0] m_axi4_arready              ; 

wire                  [NUM_SLAVE*4-1:0] m_axi4_rid                  ; 
wire                [NUM_SLAVE*512-1:0] m_axi4_rdata                ; 
wire                  [NUM_SLAVE*2-1:0] m_axi4_rresp                ; 
wire                    [NUM_SLAVE-1:0] m_axi4_rlast                ; 
wire                  [NUM_SLAVE*2-1:0] m_axi4_ruser                ; 
wire                    [NUM_SLAVE-1:0] m_axi4_rvalid               ; 
wire                    [NUM_SLAVE-1:0] m_axi4_rready               ; 

wire                  [NUM_SLAVE*4-1:0] m_axi4_awid                 ; 
wire                 [NUM_SLAVE*32-1:0] m_axi4_awaddr               ; 
wire                  [NUM_SLAVE*8-1:0] m_axi4_awlen                ; 
wire                  [NUM_SLAVE*3-1:0] m_axi4_awsize               ; 
wire                  [NUM_SLAVE*2-1:0] m_axi4_awburst              ; 
wire                  [NUM_SLAVE*4-1:0] m_axi4_awion                ; 
wire                    [NUM_SLAVE-1:0] m_axi4_awlock               ; 
wire                  [NUM_SLAVE*4-1:0] m_axi4_awcache              ; 
wire                  [NUM_SLAVE*3-1:0] m_axi4_awprot               ; 
wire                  [NUM_SLAVE*4-1:0] m_axi4_awqos                ; 
wire                  [NUM_SLAVE*2-1:0] m_axi4_awuser               ; 
wire                    [NUM_SLAVE-1:0] m_axi4_awvalid              ; 
wire                    [NUM_SLAVE-1:0] m_axi4_awready              ; 

wire                  [NUM_SLAVE*4-1:0] m_axi4_wid                  ; 
wire                [NUM_SLAVE*512-1:0] m_axi4_wdata                ; 
wire                 [NUM_SLAVE*64-1:0] m_axi4_wstrob               ; 
wire                    [NUM_SLAVE-1:0] m_axi4_wlast                ; 
wire                  [NUM_SLAVE*2-1:0] m_axi4_wuser                ; 
wire                    [NUM_SLAVE-1:0] m_axi4_wvalid               ; 
wire                    [NUM_SLAVE-1:0] m_axi4_wready               ; 

wire                  [NUM_SLAVE*4-1:0] m_axi4_bid                  ; 
wire                  [NUM_SLAVE*2-1:0] m_axi4_bresp                ; 
wire                  [NUM_SLAVE*2-1:0] m_axi4_buser                ; 
wire                    [NUM_SLAVE-1:0] m_axi4_bvalid               ; 
wire                    [NUM_SLAVE-1:0] m_axi4_bready               ; 
...
always #2 clk_sys[0] = ~clk_sys[0];
always #2.5 clk_sys[1] = ~clk_sys[1];
...
initial begin
    ...
    #1000;
    u0_axi4_mdl.axi4_write('h1,2'b1,32'h8000_1000,8'h3f,3'h5);
    u0_axi4_mdl.axi4_write('h1,2'b1,32'h8000_2000,8'h3f,3'h5);
    u0_axi4_mdl.axi4_write('h1,2'b1,32'h8000_3000,8'hff,3'h5);
    u0_axi4_mdl.axi4_write('h2,2'b1,32'h8000_4000,8'hff,3'h4);
    u0_axi4_mdl.axi4_write('h3,2'b1,32'h8000_5100,8'h10,3'h4);
    u0_axi4_mdl.axi4_write('h4,2'b1,32'h8000_0100,8'h10,3'h4);
    #10000;
...
//    .m00_axi4_arqos                 (                           ), // (output)
    ...
    .m00_axi4_rdata                 (m_axi4_rdata[0*512+:512]   ), // (input )
...
//    .m00_axi4_awqos                 (                           ), // (output)
    ...
    .m00_axi4_wdata                 (m_axi4_wdata[0*512+:512]   ), // (output)
    .m00_axi4_wstrob                (m_axi4_wstrob[0*64+:64]    ), // (output)
...
generate
for(i=0;i<1;i=i+1)begin:ram_loop
...
(
    ...
    .s_axi_awvalid                  (m_axi4_awvalid[i]          ), // input wire s_axi_awvalid
    .s_axi_awready                  (m_axi4_awready[i]          ), // output wire s_axi_awready
    .s_axi_wdata                    (m_axi4_wdata[i*512+:512]   ), // input wire [31 : 0] s_axi_wdata
    .s_axi_wstrb                    (m_axi4_wstrob[i*64+:64]    ), // input wire [3 : 0] s_axi_wstrb
    .s_axi_wlast                    (m_axi4_wlast[i]            ), // input wire s_axi_wlast
    .s_axi_wvalid                   (m_axi4_wvalid[i]           ), // input wire s_axi_wvalid
    .s_axi_wready                   (m_axi4_wready[i]           ), // output wire s_axi_wready
    .s_axi_bid                      (m_axi4_bid[i*4+:4]         ), // output wire [3 : 0] s_axi_bid
    ...
    .s_axi_arready                  (m_axi4_arready[i]          ), // output wire s_axi_arready
    .s_axi_rid                      (m_axi4_rid[i*4+:4]         ), // output wire [3 : 0] s_axi_rid
    .s_axi_rdata                    (m_axi4_rdata[i*512+:512]   ), // output wire [31 : 0] s_axi_rdata
    .s_axi_rresp                    (m_axi4_rresp[i*2+:2]       ), // output wire [1 : 0] s_axi_rresp
    .s_axi_rlast                    (m_axi4_rlast[i]            ), // output wire s_axi_rlast
    .s_axi_rvalid                   (m_axi4_rvalid[i]           ), // output wire s_axi_rvalid
    .s_axi_rready                   (m_axi4_rready[i]           ), // input wire s_axi_rready
